document.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadAllData() {
    ...
    try {
      ...
      // ** FIX: Call the new, safe initial render function **
      initialRender();
    }
  }
  ...
  // This function is ONLY called on the very first load.
  function initialRender() {
    try {
        ...
        alert("A critical error occurred during the initial display. Please check the console.");
    }
  }

  // This function is called for all subsequent view changes.
  const render = () => {
  ...
  function applyTheme(themeName) {
    ...
    // Use classList to avoid overwriting other potential classes
